package net.googlepox.metallurgy.fluid;
...
public class FluidRegistryContainer {
    ...
    public final FlowingFluidObject<ForgeFlowingFluid> flowingFluidObject;
    ...
    public FluidRegistryContainer(String name, FluidType.Properties typeProperties,
        ...
        this.type = MetalRegistry.FLUID_TYPES.register(name, () -> new FluidType(this.typeProperties) {
            @Override
        ...
        this.source = MetalRegistry.FLUIDS.register(name + "_source", () -> new ForgeFlowingFluid.Source(this.properties));
        this.flowing = MetalRegistry.FLUIDS.register(name + "_flowing",
        ...
        this.block = MetalRegistry.BLOCKS.register(name, () -> new LiquidBlock(this.source, blockProperties));
        this.properties.block(this.block);

        this.bucket = MetalRegistry.ITEMS.register(name + "_bucket", () -> new BucketItem(this.source, itemProperties));
        this.properties.bucket(this.bucket);

        flowingFluidObject = new FlowingFluidObject<>(new ResourceLocation(name), null, this.type, this.source, this.flowing, this.block);
    }
